...
class BaseTestCase(unittest.TestCase):
    ...
    def fakedb():
        ...
        image2 = Entity(type=0, key='key2', thumb_key="t2",
                        status=0)
        task1 = Task(id=101, name='task1', time=datetime.now(), type=0,
        ...
        video2 = Entity(type=2, key='key4', thumb_key="t4",
                        status=1)
        task2 = Task(id=102, name='task2', time=datetime.now(), type=2,
                     labels=['dog', 'cat', 'bird'])
        task2.creator = user2
        task2.labeler = user1
        ...
        image6 = Entity(type=1, key='key6', thumb_key="t6",
                        status=2)
        task3 = Task(id=103, name='task3', time=datetime.now(), type=1,
